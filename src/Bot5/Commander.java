...
public class Commander extends Robot {
    ...
    public void getFlagSafeties() throws GameActionException {
        ...
        int halfwayToTheMiddle = MapHelper.poseEncoder(new MapLocation(
                                        (closestSpawn.x + rc.getMapWidth()) / 2,
                                        (closestSpawn.y + rc.getMapHeight()) / 2
                                 ));

        rc.writeSharedArray(7, MapHelper.poseEncoder(weakestSpot));
        rc.writeSharedArray(8, MapHelper.poseEncoder(weakestSpot));
        rc.writeSharedArray(9, MapHelper.poseEncoder(weakestSpot));
